         ...
         <div id='video_view' className="flex">
          ...
          <div id='video' className="ml-[2rem] mr-8 my-[4.8rem] w-[65%] ">
            ...
            <div className="bg-[#292929] text-white mt-3 rounded-[0.6rem] p-4">
               ...
               <h3 className="text-[0.96rem]">This is a YouTube Clone project built with MERN stack (MongoDB, Express, React, Node.js). It demonstrates video streaming capabilities with a modern responsive interface. Click 'More' to see the technical details.</h3>
            </div>
